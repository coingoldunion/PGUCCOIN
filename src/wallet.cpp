...
// plusgoldunioncoin: total coins staked (non-spendable until maturity)
...
// plusgoldunioncoin: check 'spent' consistency between wallet and txindex
// plusgoldunioncoin: fix wallet spent state according to txindex
...
// plusgoldunioncoin: disable transaction (only for coinstake)
