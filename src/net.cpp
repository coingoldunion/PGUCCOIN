...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("plusgoldunioncoin-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("plusgoldunioncoin-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("plusgoldunioncoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "plusgoldunioncoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"194.135.93.84", "194.135.93.84"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("plusgoldunioncoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("plusgoldunioncoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("plusgoldunioncoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("plusgoldunioncoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. plusgoldunioncoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("plusgoldunioncoin-start");
